...
import { Request } from '@hoot-hoot/common-server-js'
...
/**
 * The `hoot-hoot` standard request with attached identity information. It is an extension of the standard {@link Request},
